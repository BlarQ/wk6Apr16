...
pOne.style.fontSize = '30px'
pOne.style.paddingInline = '20px'
...
pTwo[0].style.fontSize = '30px'
pTwo[0].style.paddingInline = '20px'
...
pTwo[1].style.fontSize = '30px'
pTwo[1].style.paddingInline = '20px'
...
pTwo[2].style.fontSize = '30px'
pTwo[2].style.paddingInline = '20px'
...
pTag[4].style.fontSize = '30px'
pTag[4].style.paddingInline = '20px'
...
pTag1[5].style.fontSize = '30px'
pTag1[5].style.paddingInline = '20px'

const pTag2 = document.getElementsByTagName('p')

pTag2[6].innerText = 'Hobbies: My hobbies are; \n \n Dancing \n \n Singing \n \n  Coding'

pTag2[6].style.fontSize = '30px'
pTag2[6].style.paddingInline = '20px'
